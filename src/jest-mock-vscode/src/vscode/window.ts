...
async function showTextDocument(
  a: vscode.TextDocument | vscode.Uri,
  b?: vscode.ViewColumn | vscode.TextDocumentShowOptions,
  ...
  const selection =
    selectionRange && new Selection(selectionRange.start, selectionRange.start);
