...
import { FileSystems } from '../constants';
 ...
 */
export class PsFileSystem implements vscode.Disposable {
    protected disposables: vscode.Disposable[] = [];
    protected fs: vscode.FileSystemProvider;

    constructor() {
        this.fs = new DateiFileSystemProvider();
        this.disposables.push(
            vscode.workspace.registerFileSystemProvider(FileSystems.PsFs, this.fs, { isCaseSensitive: true }));
